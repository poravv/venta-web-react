...
const ResolucionENAModifTemplate = ({considerando,visto,numero, resolucion, list_estudiantes }) => {
            ...
            <div style={styles.page}>
                ...
                <div className='row'>
                    ...
                    <div className='col' style={{ fontSize: `9px`, textAlign: `justify`, textIndent: `-30px` }}>
                        {(visto===null||visto==='')?`La Nota elevada por la Dirección Académica de la Escuela Náutica de la Armada (ENA), en la cual fue desarrollada el "${resolucion?.curso}" desarrollado del ${resolucion?.finicio} al ${resolucion?.ffin}, conforme a lo establecido en el calendario anual de la ENA; y `:visto}
                    </div>
                </div>
                <br />
                <div className='row'>
                    ...
                    <div className='col' style={{ fontSize: `9px`, textAlign: `justify`, textIndent: `-30px` }}>
                        {(considerando===null||considerando==='')?`El Decreto N° 11075 del 19 de Octubre de 2007, por el cual se crea la Escuela Náutica de la Armada (ENA), dependiente del Comando de Institutos Navales de Enseñanza, quien se encargará de la formación y capacitación profesional del personal de de Empresas Navieras y Puertos Privados, para adecuarse a los requerimientos de las Leyes Nacionales vigentes y otras normas Internacionales, exigidas por la Organización Marítima Internacional (OMI). La Resolución N° 439/2021, del Ministerio de Educación y Ciencias (MEC), de fecha 28 de Diciembre de 2021, por la cual se habilitan cursos.`:considerando}
                    </div>
                </div>
...
export default ResolucionENAModifTemplate;