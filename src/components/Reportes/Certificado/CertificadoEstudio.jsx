...
import CertificadoEstudioTemplate from './CertificadoEstudioTemplate';
...
function CertificadoEstudio({ token }) {
    ...
    return (
        <div >
            <div style={{ marginBottom: `20px` }}>
                ...
                <Titulos text={`CERTIFICADO DE ESTUDIO`} level={3}></Titulos>
            </div>
            <Form
                name="basic"
                layout="vertical"
            ...
            {banderabtn === true ?
                    <div ref={reportTemplateRef} >
                        <CertificadoEstudioTemplate certEst={certEst[0]} evaluacionesDet={evaluacionesDet} />
                    </div>
                :
                null
            }
...
export default CertificadoEstudio;