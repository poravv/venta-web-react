...
import ResolucionENATemplate from './ResolucionENATemplate';
...
function ResolucionENA({ token }) {
    ...
    const [resolucion, setResolucionENA] = useState([]);
    ...
    const BuscaEstudiantes = async () => {
        try {
            ...
            await getarescabena({ token: token, idconvocatoria: idconvocatoria }).then((resultado) => {
                ...
                setResolucionENA(resultado.body)
            });
        } catch (error) {
            console.log(error)
        }
        ...
        <div >
            ...
            {banderabtn === true ?
                <div ref={reportTemplateRef} >
                    <ResolucionENATemplate numero={numero} resolucion={resolucion[0]} list_estudiantes={list_estudiantes} />
                </div>
                :
                null
            }
